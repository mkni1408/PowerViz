...
class ApplicationMain
{
	...
	{
		#if openfl
		flash.Lib.setPackage("Company Name", "EcoViz", "com.example.ecoviz", "1.0.0");
		...
		wx.App.boot(function()
		{
			...
			frame = wx.Frame.create(null, null, "EcoViz", null, { width: 1066, height: 600 });
			
			#if openfl
			var stage = wx.NMEStage.create(frame, null, null, { width: 1066, height: 600 });
			#end
